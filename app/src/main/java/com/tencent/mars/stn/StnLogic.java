...
public class StnLogic {
    ...
    public interface ICallBack {
         ...
         * @return
         */
        int onTaskEnd(final int taskID, Object userContext, final int errType, final int errCode, CgiProfile profile);
     ...
     */
    public static native void resetAndInitEncoderVersion(int packerEncoderVersion, String extra);
     ...
     * @return
     */
    private static int onTaskEnd(final int taskID, Object userContext, final int errType, final int errCode, final CgiProfile profile){
        try {
            if (callBack == null) {
                new NullPointerException("callback is null").printStackTrace();
                return 0;
